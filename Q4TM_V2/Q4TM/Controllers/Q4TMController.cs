...
namespace Q4TM.Controllers
{
    public class Q4TMController : Controller
    {
        ...
        // This method is used to display the about page
        ...
        // This method is used to display the 4 quadrants page page
        ...
        //    {
        //        QTMEntities db = new QTMEntities();
        //        List<EmpTaskList> li = db.EmpTaskLists.ToList();
        //        return View(li);
        //    }
        //    else
        //    {
        ...
        public JsonResult UpdateEmployee(EmployeeTaskModel employees)
        {
            ...
            EmpTaskList updatedEmployee = (from c in entities.EmpTaskLists
                ...
                if(updatedEmployee.Start_Time>=updatedEmployee.End_Time)
                {
        ...
        public JsonResult DeleteEmployee(int taskId)
        {
            ...
            deletedtedEmployee.Quadrant_Id = null;
            entities.SaveChanges();      
        ...
        public JsonResult UpdateStatus(EmployeeTaskModel employees)
        {
            ...
            EmpTaskList updateStatus = (from c in entities.EmpTaskLists
                                                where c.TaskId == employees.TaskId
                                                select c).FirstOrDefault();
            updateStatus.Status_Percentage = employees.Status;
            entities.SaveChanges();
        ...
        // This method is used to move the tasks from one quadrant to another quadrant based on user choice
        [HttpPost]
        public JsonResult moveList(string ItemList, string TableName)
        {
            var main = ItemList.Split(',');
            QTMEntities db = new QTMEntities();
            foreach (var itm in main)
